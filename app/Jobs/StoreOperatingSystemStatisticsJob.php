...
class StoreOperatingSystemStatisticsJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $google_data = GoogleAnalyticsService::getAdOperatingSystems($this->filter);

        //sync data (delete old data for ads)
        $oldData = AdDevices::where('ad_id', $this->item_id)->where('key', 'operating_system')->get();
