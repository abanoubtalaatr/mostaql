...
class StoreBrowserStatisticsJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $google_data = GoogleAnalyticsService::getAdBrowsers($this->filter);

        //sync data (delete old data for ads)
        $oldData = AdDevices::where('ad_id', $this->item_id)->where('key', 'browsers')->get();
