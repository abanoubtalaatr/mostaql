            ...
            <form class="text-right" wire:submit.prevent="store">
                <div class="row row-cols-1 row-cols-md-2">
                    <div class="col-md-12 my-2">
                        ...
                        <input  wire:model.defer="form.title" type="text" class="form-control text-right" maxlength="70">
            ...
            <div class="card bg-transparent border-0">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        سيظهر للمنفذين في صفحة المشاريع ويقدموا عروضهم عليه لتختار
                        العرض الأنسب لك ويبدأ المنفذ بتنفيذ المشروع.
                    </p>
                </div>
                <div class="card-body">
                    <h5 class="card-title">موقع ... يضمن حقوقك</h5>
                    <p class="card-text">
                        تقوم المنصه بدور الوسيط بينك وبين المنفذ الذي توظفه لتنفيذ
                        مشروعك، فقط بعد انتهاء المنفذ من تنفيذ المشروع كاملاً يتم تحويل
                        المبلغ إلى حسابه.
                    </p>
                </div>
                <div class="card-body">
