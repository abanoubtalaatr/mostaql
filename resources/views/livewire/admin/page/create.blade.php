            ...
            <form wire:submit.prevent='store'>
                <div class="row">
                    <div class="col-12">
                        ...
                        <input wire:model.defer='form.title_ar'
                ...
                <div class="row">
                    ...
                    <div class="col-12" wire:ignore>
                        ...
                        <textarea id="my-editor" wire:model="content"></textarea>
        ...
        const editor = tinymce.init({
            ...
            setup: function (editor) {
                editor.on('change', function () {
                    Livewire.emit('updatedContent', editor.getContent());
                });
            }
        });

        Livewire.on('editorUpdated', function () {
