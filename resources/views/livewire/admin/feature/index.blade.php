...
{{--            <h4>{{$page_title}}</h4>--}}
{{--            <a style='text-align:center' href='{{route('admin.feature.create')}}' class="button btn-red big">@lang('site.create_new')</a>--}}
{{--        </div>--}}
...
{{--                                    <td>--}}
{{--                                        <div class="actions">--}}
{{--                                            <a class="no-btn" href='{{route('admin.feature.edit',$record)}}'><i class="far fa-edit blue"></i></a>--}}
