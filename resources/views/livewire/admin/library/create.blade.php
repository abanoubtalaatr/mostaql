            ...
            <div class="row mt-30">
              ...
              <div class="col-lg-5">
                <form wire:submit.prevent='store' class='scroll-form'>
                    <div class="ad-new w-100">
                        <div class="ad-form w-100">
                            <div wire:ignore class='w-100'>
                                <label class=' w-100' for="">@lang('site.select_category')</label>
                                <select
                                    wire:model='form.category_id'
                                    class="@error('form.category_id') is-invalid @enderror form-control contact-input  w-100"
                                    id='category_id'
                                >
                        ...
                        <div class="ad-form">
                            ...
                            <div class="">
                                ...
                                @error('media_files') <p class="text-danger">{{$message}}</p> @enderror
                            </div>


                            <div class="btns text-center">
                                <button wire:loading.attr="disabled" wire:loading.class.remove="bg-blue" type='submit' class="button btn-red big">@lang('site.save')</button>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="ad-wrap" style='display:block !important'>
                                <div class="mac-wrap" style="position: relative">
                                    ...
                                    @else
                                        {{-- <img class="ad" src="{{$media_preview}}" style="max-width:100%;max-height:100%" /> --}}
                                         <div class="my-slider ad">
                                            @foreach($media_files as $single_media)
                                                <div >
                                                    <img class="my-slider-image" src="{{$single_media->temporaryUrl()}}" />
                                                </div>
                                            @endforeach
                                        </div>
                                    @endif
                            ...
                            <div class="ad-wrap" style='display:block !important'>
                                <div class="mob-wrap" >
                                    ...
                                    @else
                                         <div class="my-slider ad">
                                            @foreach($media_files as $single_media)
                                                <img class="" src="{{$single_media->temporaryUrl()}}" style="max-height: 350px;object-fit:contain">
                                            @endforeach
                                        </div>
                                    @endif
